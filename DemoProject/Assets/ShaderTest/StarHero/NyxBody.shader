...
Shader "NyxBody"
{
	Properties
	{
		...
		_StarSpeed("StarSpeed", Vector) = (0,0,0,0)
		_BlingPower("BlingPower", Float) = 9
		_BlingScale("BlingScale", Float) = 0
		_BlingSpeed("BlingSpeed", Float) = 1
	...
	SubShader
	{
		...
		uniform float2 _StarSpeed;
		uniform float4 _TillingAndOffset;
		uniform float _RefractFactor;
		uniform float _BlingPower;
		uniform float _BlingScale;
		uniform float _BlingSpeed;
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float3 world_normal4 = normalize( (WorldNormalVector( i , tex2D( _NormalMap, uv_NormalMap ).rgb )) );
			...
			float2 panner93 = ( 1.0 * _Time.y * _StarSpeed + ( ( (( objToView68 - objToView71 )).xy * (_TillingAndOffset).xy ) + (_TillingAndOffset).zw + ( (objToWorldDir90).xy * _RefractFactor ) ));
			float4 InsideColor88 = tex2D( _InsideMap, panner93 );
			float4 temp_cast_1 = (_BlingPower).xxxx;
			o.Emission = ( RimColor28 + ( FlowLightColor57 * _FlowLightIntensity ) + ( InsideColor88 * FlowLight43 ) + ( pow( InsideColor88 , temp_cast_1 ) * _BlingScale * pow( FlowLight43 , _BlingSpeed ) ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
1920;0;1920;1019;1315.34;89.14453;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;5;-2632.249,-982.1153;Inherit;False;820.784;280;Comment;3;1;2;4;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;1;-2582.249,-932.1153;Inherit;True;Property;_NormalMap;NormalMap;0;0;Create;True;0;0;0;False;0;False;-1;None;48bbd7b242c01ad49a187d85e46d4507;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;36;-2339.619,1008.69;Inherit;False;Property;_FlowTillingSpeed;FlowTillingSpeed;6;0;Create;True;0;0;0;False;0;False;1,1,0,0.2;0.8,0.8,0,0.3;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;74;-2213.772,2434.007;Inherit;False;Property;_TillingAndOffset;TillingAndOffset;11;0;Create;True;0;0;0;False;0;False;1,1,0,0;0.5,0.5,-0.56,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-2531.052,2827.207;Inherit;False;Property;_RefractFactor;RefractFactor;13;0;Create;True;0;0;0;False;0;False;0;0.02;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2359.342,1812.365;Inherit;False;Property;_FlowRimScale;FlowRimScale;9;0;Create;True;0;0;0;False;0;False;1;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-2168.608,242.4049;Inherit;False;Property;_RimPower;RimPower;1;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;17;-2162.093,89.57399;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;41;-1437.514,576.066;Inherit;True;Property;_FlowMap;FlowMap;5;0;Create;True;0;0;0;False;0;False;-1;None;c0262c1215cc6604785ec672f25d45e8;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;94;-1763.482,2680.704;Inherit;False;Property;_StarSpeed;StarSpeed;14;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.PannerNode;93;-1477.482,2575.704;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;18;-1981.408,139.4045;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;63;-2115.889,1853.809;Inherit;False;Property;_FlowRimBias;FlowRimBias;10;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;79;-1414.811,2307.343;Inherit;True;Property;_InsideMap;InsideMap;12;0;Create;True;0;0;0;False;0;False;-1;None;f8a2129bc7dbca540bbee6c219e4f2af;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;56;-2083.399,1536.197;Inherit;False;Property;_FlowLightColor;FlowLightColor;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2862746,0.3933071,0.9058824,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;24;-1669.063,-87.60779;Inherit;False;Property;_RimColor;RimColor;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4274208,0.6817045,0.8018868,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-723.5908,401.8962;Inherit;False;Property;_BlingPower;BlingPower;15;0;Create;True;0;0;0;False;0;False;9;20;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;100;-685.3401,602.8555;Inherit;False;43;FlowLight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-669.3401,692.8555;Inherit;False;Property;_BlingSpeed;BlingSpeed;17;0;Create;True;0;0;0;False;0;False;1;3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;52;-838.4427,-197.4719;Inherit;False;Property;_FlowLightIntensity;FlowLightIntensity;7;0;Create;True;0;0;0;False;0;False;0.1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;98;-690.5908,504.8962;Inherit;False;Property;_BlingScale;BlingScale;16;0;Create;True;0;0;0;False;0;False;0;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;91;-821.2834,111.7666;Inherit;False;43;FlowLight;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;95;-521.5908,341.8962;Inherit;False;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;46;-849.0818,-305.6359;Inherit;False;57;FlowLightColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;101;-453.3401,593.8555;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;97;-270.5908,339.8962;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;50;-256.8428,-343.6718;Inherit;False;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;50;3;97;0
WireConnection;0;2;50;0
ASEEND*/
//CHKSM=3C2FE56D8022AFE56262A03DB667180645D70738